...
INSERT INTO team (team_id, team_name, team_country, venue_id)
    VALUES
        (1, 'Þróttur', 'Iceland', 1),
        (2, 'Breiðablik', 'Iceland', 2),
        (3, 'Þór', 'Iceland', 3);

INSERT INTO player (player_id, player_name, date_of_birth, player_country, player_position, goals, team_id)
    VALUES
        (1, 'John Snow', '2007-12-03', 'England', 'GOALKEEPER', 13, 1),
